...
if(isset($_POST['submit']))
{
	...
	$update = "UPDATE card_activation SET u_card='$u_card', u_f_name = '$u_f_name', u_l_name = '$u_l_name', u_father = '$u_father', u_mother = '$u_mother', u_cnic = '$u_cnic', u_birthday = '$u_birthday', u_gender = '$u_gender', u_email = '$u_email', u_phone = '$u_phone', u_dist = '$u_dist', u_village = '$u_village', u_police = '$u_police', u_pincode = '$u_pincode', u_family = '$u_family', staff_id = '$u_staff_id', image = '$image' WHERE id=$id ";
